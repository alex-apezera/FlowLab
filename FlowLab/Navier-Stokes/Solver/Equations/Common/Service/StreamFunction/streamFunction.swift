...
//
//MARK: - Calculate Stream Function by Integral u = ∂ψ/∂y, v = - ∂ψ/∂x

extension NavierStokesSolver {
 
    /// Интегрирование функции тока из уравнений u = ∂ψ/∂y, v = - ∂ψ/∂x
    func streamFunction(u: [Double], v: [Double], rx: [Double], fl: [Double]) -> [Double] {
        ...
        fl.withUnsafeBufferPointer { fl in
