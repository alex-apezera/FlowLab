...
// MARK: - Алгоритм Томаса (Трехдиагональная прогонка)
...
func thomasSolveInPlace(a: [Double], b: [Double], c: [Double], d: [Double], count n: Int, solution: inout [Double], cPrime: inout [Double], dPrime: inout [Double]) {
